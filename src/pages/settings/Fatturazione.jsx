  ...
  return (
    <div className="px-8 py-6 max-w-2xl space-y-4">
      <div className="bg-white rounded-xl border border-gray-100 p-5 relative">
        <div className="absolute top-3 right-3 bg-yellow-100 text-yellow-700 text-xs font-semibold px-2 py-0.5 rounded-full">+ Prova</div>
        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">PIANO PRO</div>
        <div className="text-4xl font-black text-gray-900 mb-1">€39 <span className="text-base font-normal text-gray-500">/ mese</span></div>
        <div className="grid grid-cols-3 gap-4 mt-3 mb-4 text-xs text-gray-500">
          <div><div className="text-gray-400">Dimensione team</div><div className="font-semibold text-gray-900">1 seat</div></div>
          <div><div className="text-gray-400">Prossimo pagamento</div><div className="font-semibold text-gray-900">—</div></div>
          <div><div className="text-gray-400">Fatturazione</div><div className="font-semibold text-gray-900">Mensile</div></div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400">Carta in archivio</div>
            </div>
          </div>
